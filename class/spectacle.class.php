...
/**
 * \file        class/spectacle.class.php
 * \ingroup     modulespectacle
 * \brief       This file is a CRUD class file for spectacle (Create/Read/Update/Delete)
 */
...
class Spectacle extends CommonObject
{
	 ...
	 */
	public $element = 'spectacle';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'modulespectacle_spectacle';

	/**
	 * @var int  Does spectacle support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does spectacle support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for spectacle. Must be the part after the 'object_' into object_spectacle.png
	 */
	public $picto = 'spectacle@modulespectacle';
	...
	public $fields=array(
		...
		'label' => array('type'=>'varchar(255)', 'label'=>'Label', 'enabled'=>1, 'visible'=>1, 'position'=>30, 'notnull'=>-1, 'searchall'=>1, 'help'=>'HelpTextLabel', 'showoncombobox'=>'1',),
		'amount' => array('type'=>'double(24,8)', 'label'=>'Amount', 'enabled'=>1, 'visible'=>1, 'position'=>40, 'notnull'=>-1, 'default'=>'null', 'isameasure'=>'1', 'help'=>'HelpTextAmount',),
	 ...
	 */
	//public $table_element_line = 'spectacledet';

	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_spectacle';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'spectacleline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('spectacledet');

	/**
	 * @var spectacleLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object spectacleLine
...
/**
 * Class spectacleLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class spectacleLine
{
