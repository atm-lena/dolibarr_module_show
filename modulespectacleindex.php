...
/**
 *	\file       htdocs/modulespectacle/template/modulespectacleindex.php
 *	\ingroup    modulespectacle
 *	\brief      Home page of modulespectacle top menu
 */
...
$langs->loadLangs(array("modulespectacle@modulespectacle"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->modulespectacle->read) accessforbidden();
...
llxHeader("",$langs->trans("ModuleSpectacleArea"));

print load_fiche_titre($langs->trans("ModuleSpectacleArea"),'','modulespectacle.png@modulespectacle');
...
// Draft MyObject
if (! empty($conf->modulespectacle->enabled) && $user->rights->modulespectacle->read)
{
	$langs->load("orders");
