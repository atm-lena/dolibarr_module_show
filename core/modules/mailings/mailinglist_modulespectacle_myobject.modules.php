...
dol_include_once("/modulespectacle/class/myobject.class.php");


/**
 * mailing_mailinglist_modulespectacle
 */
class mailing_mailinglist_modulespectacle_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_modulespectacle_myobject';
	...
	var $picto='modulespectacle@modulespectacle';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('modulespectacle',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/modulespectacle/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_modulespectacle_myobject.modules.php: mailing ".$num." targets found");
