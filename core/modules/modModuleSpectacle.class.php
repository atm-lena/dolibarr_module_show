...
//        $this->module_parts = array('hooks' => array('searchform'));
		...
		// );
		$this->const = array(
			1=>array('MODULESPECTACLE_MYCONSTANT', 'chaine', 'avalue', 'This is a constant to add', 1, 'allentities', 1)
		);
	...
	public function init($options='')
	{
		...
		//$result1=$extrafields->addExtraField('myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'modulespectacle@modulespectacle', '$conf->modulespectacle->enabled');
