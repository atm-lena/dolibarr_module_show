...
/**
 * \file    test/functional/ModuleSpectacleFunctionalTest.php
...
/**
 * Class ModuleSpectacleFunctionalTest
 *
 ...
 *
 * @package Testmodulespectacle
 */
class ModuleSpectacleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modModuleSpectacle')->click();
		} else {
			// Disable the module
			$this->byHref('modModuleSpectacle')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/modulespectacle/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('modulespectacle/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/modulespectacle/admin/about.php');
		$this->authenticate();
		return $this->assertContains('modulespectacle/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('modulespectaclewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modModuleSpectacle_ModuleSpectacleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modModuleSpectacle_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
